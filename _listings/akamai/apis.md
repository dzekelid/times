...
- name: Akamai API Report Security Event Time Series
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/times/master/_listings/akamai/etp-report-v1-configs-configid-threat-events-time-series-get.md
x-common:
- type: x-base
